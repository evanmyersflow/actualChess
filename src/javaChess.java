    ...
    private fun printBoard() {
        ...
        for (i in 7 downTo 0){
            for (j in 0. .7){
                ...
                letOnSquare(coordinate) {
                    NullPiece(it, coordinate)
                }
...
//Pieces
    ...
    isWhite:Boolean,
    override val
    coordinate:Coordinate):Piece

    {
        override val validMoves:
    List<Coordinate>
        get() {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

        override fun toString():String = if (isWhite) "Rw"
    else "Rb"
    }
    ...
    List<Coordinate>
        ...
        override fun toString():String = if (isWhite) "Nw"
    else "Nb"
    }
    ...
    List<Coordinate>
        ...
        override fun toString():String = if (isWhite) "Bw"
    else "Bb"
    }
    ...
    List<Coordinate>
        ...
        override fun toString():String = if (isWhite) "Qw"
    else "Qb"
    }
    ...
    List<Coordinate>
        ...
        override fun toString():String = if (isWhite) "Kw"
    else "Kb"
    }
    ...
    List<Coordinate>
        ...
        override fun toString():String = if (isWhite) "Pw"
    else "Pb"
    }
...
//Squares
    ...
    List<Coordinate>
        ...
        override fun toString():String = if (isWhite) "~ "
    else "- "
    }
